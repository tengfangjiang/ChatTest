package com.example.ihealthtek.ipoctchattest.db;

import android.content.ContentValues;
import android.database.Cursor;
import android.database.sqlite.SQLiteDatabase;

import com.example.ihealthtek.ipoctchattest.Constant;
import com.example.ihealthtek.ipoctchattest.TestApplication;
...
public class DemoDBManager {
    ...
    private DemoDBManager() {
        dbHelper = DbOpenHelper.getInstance(TestApplication.getInstance().getApplicationContext());
    }
